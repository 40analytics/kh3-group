...
const LeadsClient: React.FC<LeadsClientProps> = ({ leads }) => {
  ...
  const handleAnalyzeRisk = async (lead: Lead) => {
    ...
    try {
      ...
      alert('Failed to analyze risk. Please check if backend is running and AI provider is configured.');
    } finally {
      setAiLoading(false);
    }
  };
  ...
  const handleCreateLead = async (e: React.FormEvent) => {
    ...
    try {
      await api.leads.create({
        ...
        expectedCloseDate: new Date(newLeadForm.expectedCloseDate),
      ...
      alert('Failed to create lead. Please check if backend is running.');
    }
  };
      ...
      <div className="flex-1 overflow-x-auto pb-4">
        <div className="flex space-x-4 min-w-[1200px] h-full">
          {columns.map((stage) => (
            <div
              key={stage}
              className="flex-col flex-1 min-w-[280px] bg-gray-100/50 rounded-xl p-3 border border-gray-200 h-full overflow-hidden flex">
            ...
            <div className="p-6 space-y-8 flex-1">
              ...
              <div className="bg-indigo-50 border border-indigo-100 rounded-xl p-5">
                ...
                {selectedLead.aiRiskLevel ? (
                  ...
                  <p className="text-sm text-gray-500">
                    ...
                    conversion probability. Make sure backend has an AI provider configured.
                  </p>
                )}
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                ...
                <DetailItem
                  ...
                  value={selectedLead.expectedCloseDate ? new Date(selectedLead.expectedCloseDate).toLocaleDateString() : 'Not set'}
                />
                <DetailItem
                  label="Source"
