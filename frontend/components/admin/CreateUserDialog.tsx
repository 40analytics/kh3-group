...
export function CreateUserDialog({
  ...
  const getAllowedRoles = (): Array<'ADMIN' | 'MANAGER' | 'SALES'> => {
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                A welcome email has been sent to {createdUser.email} with login instructions.
              </p>
            </div>
            ...
            <Alert>
              ...
              <AlertDescription className="text-sm">
                The user must change this password after their first login for security.
              </AlertDescription>
            </Alert>
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Add a new user to the system. A temporary password will be generated and sent via email.
          </DialogDescription>
        </DialogHeader>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input type="email" placeholder="john@khygroup.com" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    {currentUserRole === 'CEO' && 'You can create Admin, Manager, or Sales users'}
                    {currentUserRole === 'ADMIN' && 'You can create Manager or Sales users'}
                    {currentUserRole === 'MANAGER' && 'You can create Sales users only'}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            {selectedRole && ['MANAGER', 'SALES'].includes(selectedRole) && (
              <FormField
                control={form.control}
                name="teamName"
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      {currentUserRole === 'MANAGER'
                        ? 'Auto-filled with your team name'
            ...
            {selectedRole === 'SALES' && currentUserRole !== 'MANAGER' && managers.length > 0 && (
              <FormField
                control={form.control}
                name="managerId"
                render={({ field }) => (
